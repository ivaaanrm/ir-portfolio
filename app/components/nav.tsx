...
export function Navbar() {
  ...
  return (
    <>
      ...
      >
        <div className="max-w-[680px] mx-auto px-6 sm:px-4 md:px-0">
          <div className={`flex items-center justify-between transition-all duration-300 ${isScrolled ? 'py-5' : 'py-8'}`}>
            <Link href="/" className="font-serif-display italic text-2xl leading-none text-neutral-900">
              {metaData.title}
            </Link>
